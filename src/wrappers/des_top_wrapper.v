// Optional wrapper for reduced-I/O integration scenarios.
//
// This module allows loading the 64-bit DES key and 64-bit input block
// through a 32-bit shared data bus, controlled by a small selector interface.
// It was explored as an alternative top-level integration option for FPGA
// targets with tighter I/O constraints than the main des_top interface.
//
// The primary project flow uses des_top directly; this wrapper is kept as a
// documented architectural variant.
